...
export default function QRCodeGenerator() {
  ...
  const downloadQRCode = async (format: "png" | "svg") => {
    try {
      ...
      // Access the QR code instance
      // @ts-ignore
      const qrCodeInstance = window._qrCodeInstance;
      
      if (!qrCodeInstance) {
        throw new Error("QR code not ready. Please try again in a moment.");
      }

      // Use the QR code library's built-in download function
